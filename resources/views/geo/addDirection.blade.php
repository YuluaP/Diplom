...
@section('content')
        ...
        <div class="row">
            ...
            <form method="POST" action="{{url('directions/store')}}">
                ...
                <div>
                    ...
                    <label>
                        Адрес отправления
                        <input type="text" id="originAddress" name="originAddress" value="{{old('originAddress')}}" readonly/>
                    </label>
                        <label>
                            Адрес прибытия
    ...
    <script>
        ...
        function initMap() {
            ...
            document.getElementById('originLat').value = myLatlng.lat;
            document.getElementById('originLng').value = myLatlng.lng;
