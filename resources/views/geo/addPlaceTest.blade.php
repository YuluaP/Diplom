...
@section('breadcrumbs')
    ...
    <li><a href="{{url('/places/add')}}" class="active">Добавить</a></li>
@endsection
    ...
    <script>
        ...
        function initMap() {
            ...
            if (document.getElementById('lat').value) {
                ...
                myLatlng.lat = parseFloat(document.getElementById('lat').value);
                myLatlng.lng = parseFloat(document.getElementById('lng').value);
